...
ALTER TABLE CA_ITEM ADD CONSTRAINT FK_CA_ITEM_3 FOREIGN KEY (DEFAULT_PRICE_ID) REFERENCES CA_ITEM_PRICE (ID);
...
ALTER TABLE CA_SALES_ORDER_ITEM ADD CONSTRAINT FK_CA_SALES_ORDER_ITEM_3 FOREIGN KEY (SITE_CODE_ID) REFERENCES CA_SITE (ID);
...
ALTER TABLE CA_SALES_INVOICE_ITEM ADD CONSTRAINT FK_CA_SALES_INVOICE_ITEM_4 FOREIGN KEY (SITE_CODE_ID) REFERENCES CA_SITE (ID);
...
CREATE SEQUENCE SEQ_CA_SALES_INVOICE_ITEM START WITH 1 INCREMENT BY 1 NOMAXVALUE NOMINVALUE CACHE 20 NOINVOICE;
