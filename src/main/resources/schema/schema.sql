...
ALTER TABLE CA_PURCHASE_ORDER_ITEM ADD CONSTRAINT FK_CA_PURCHASE_ORDER_ITEM_2 FOREIGN KEY (SITE_CODE_ID) REFERENCES CA_SITE (ID);

ALTER TABLE CA_PURCHASE_ORDER_ITEM ADD CONSTRAINT FK_CA_PURCHASE_ORDER_ITEM_2 FOREIGN KEY (UNIT_CODE_ID) REFERENCES CA_UNIT_CODE (ID);
