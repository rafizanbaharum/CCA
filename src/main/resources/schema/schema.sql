...
CREATE
    ...
    (
        ...
        GENERIC_DESCRIPTION VARCHAR2 (255),
        ALLOW_BACK_ORDER NUMBER(1) DEFAULT 0,
        AP_TAX_TYPE NUMBER(1) DEFAULT 0,
        AR_TAX_TYPE NUMBER(1) DEFAULT 0,
        PRICE_METHOD NUMBER(1) DEFAULT 0,
        STANDARD_COST NUMBER(15,2),
        CURRENT_COST NUMBER(15,2),
        -- STANDARD METADATA COLUMN
        M_ST NUMBER(1) DEFAULT 0,
        C_ID NUMBER DEFAULT 0,
        C_TS TIMESTAMP DEFAULT SYSTIMESTAMP,
...
ALTER TABLE CA_ITEM ADD CONSTRAINT PK_CA_ITEM PRIMARY KEY(ID);

ALTER TABLE CA_ITEM ADD CONSTRAINT FK_CA_ITEM_1 FOREIGN KEY (ITEM_CODE_ID) REFERENCES CA_ITEM_CODE (ID);

ALTER TABLE CA_ITEM ADD CONSTRAINT FK_CA_ITEM_2 FOREIGN KEY (UNIT_CODE_ID) REFERENCES CA_UNIT_CODE (ID);

ALTER TABLE CA_ITEM ADD CONSTRAINT FK_CA_ITEM_3 FOREIGN KEY (UNIT_ACCOUNT_ID) REFERENCES CA_ACCOUNT (ID);

ALTER TABLE CA_ITEM ADD CONSTRAINT FK_CA_ITEM_4 FOREIGN KEY (DEFAULT_PRICE_ID) REFERENCES CA_ITEM_PRICE (ID);

CREATE SEQUENCE SEQ_CA_ITEM START WITH 1 INCREMENT BY 1 NOMAXVALUE NOMINVALUE CACHE 20 NOORDER;
...
CREATE
    ...
    (
        ...
        PRICE NUMBER(15,2),
        PERCENT NUMBER(15,2),
        START_QUANTITY NUMBER(15,2),
        END_QUANTITY NUMBER(15,2),
        -- STANDARD METADATA COLUMN
        MD_ST NUMBER(1) DEFAULT 0,
        C_ID NUMBER DEFAULT 0,
        C_TS TIMESTAMP DEFAULT SYSTIMESTAMP,
...
ALTER TABLE CA_ITEM_PRICE ADD CONSTRAINT PK_CA_ITEM_PRICE PRIMARY KEY(ID);

ALTER TABLE CA_ITEM_PRICE ADD CONSTRAINT FK_CA_ITEM_PRICE_1 FOREIGN KEY (ITEM_ID) REFERENCES CA_ITEM (ID);

ALTER TABLE CA_ITEM_PRICE ADD CONSTRAINT FK_CA_ITEM_PRICE_2 FOREIGN KEY (UNIT_CODE_ID) REFERENCES CA_UNIT_CODE (ID);

CREATE SEQUENCE SEQ_CA_ITEM_PRICE START WITH 1 INCREMENT BY 1 NOMAXVALUE NOMINVALUE CACHE 20 NOORDER;
...
ALTER TABLE CA_POSTING ADD CONSTRAINT FK_CA_POSTING_2 FOREIGN KEY (COMPANY_ID) REFERENCES CA_COMPANY (ID);

ALTER TABLE CA_POSTING ADD CONSTRAINT FK_CA_POSTING_3 FOREIGN KEY (ACCOUNT_ID) REFERENCES CA_ACCOUNT (ID);
...
CREATE SEQUENCE SEQ_CA_PURCHASE_ORDER START WITH 1 INCREMENT BY 1 NOMAXVALUE NOMINVALUE CACHE 20 NOORDER;
...
ALTER TABLE CA_PURCHASE_ORDER_ITEM ADD CONSTRAINT FK_CA_PURCHASE_ORDER_ITEM_3 FOREIGN KEY (SITE_CODE_ID) REFERENCES CA_SITE_CODE (ID);
...
ALTER TABLE CA_PURCHASE_INVOICE_ITEM ADD CONSTRAINT FK_CA_PURCHASE_INVOICE_ITEM_4 FOREIGN KEY (SITE_CODE_ID) REFERENCES CA_SITE_CODE (ID);
...
CREATE SEQUENCE SEQ_CA_PURCHASE_INVOICE_ITEM START WITH 1 INCREMENT BY 1 NOMAXVALUE NOMINVALUE CACHE 20 NOORDER;

-- =============================================================================================
-- CA_SALES_ORDER, CA_SALES_ORDER_ITEM
-- =============================================================================================

CREATE
    TABLE CA_SALES_ORDER
    (
    	ID NUMBER NOT NULL,
    	CUSTOMER_ID NUMBER,
    	ORDER_TYPE NUMBER(1) DEFAULT 0,
...
ALTER TABLE CA_SALES_ORDER ADD CONSTRAINT PK_CA_SALES_ORDER PRIMARY KEY(ID);

ALTER TABLE CA_SALES_ORDER ADD CONSTRAINT FK_CA_SALES_ORDER_1 FOREIGN KEY (ID) REFERENCES CA_DOCUMENT (ID);


CREATE
    TABLE CA_SALES_ORDER_ITEM
    (
    	ID NUMBER NOT NULL,
    	ORDER_ID NUMBER
    	ITEM_ID NUMBER,
        ...
        UNIT_COST NUMBER(15,2),
        EXTENDED_COST NUMBER(15,2),
        QUANTITY_TO_BACK_ORDER NUMBER(15,2),
        QUANTITY_TO_INVOICE NUMBER(15,2),
        QUANTITY_FULFILLED NUMBER(15,2),
        QUANTITY_ALLOCATED NUMBER(15,2),
        FULFILLED_DATE DATE,
        SHIPPED_DATE DATE,
        -- STANDARD METADATA COLUMN
        MD_ST NUMBER(1) DEFAULT 0,
...
ALTER TABLE CA_SALES_ORDER_ITEM ADD CONSTRAINT PK_CA_SALES_ORDER_ITEM PRIMARY KEY(ID);

ALTER TABLE CA_SALES_ORDER_ITEM ADD CONSTRAINT FK_CA_SALES_ORDER_ITEM_1 FOREIGN KEY (ORDER_ID) REFERENCES CA_SALES_ORDER (ID);

ALTER TABLE CA_SALES_ORDER_ITEM ADD CONSTRAINT FK_CA_SALES_ORDER_ITEM_2 FOREIGN KEY (ITEM_ID) REFERENCES CA_ITEM (ID);

ALTER TABLE CA_SALES_ORDER_ITEM ADD CONSTRAINT FK_CA_SALES_ORDER_ITEM_3 FOREIGN KEY (SITE_CODE_ID) REFERENCES CA_SITE_CODE (ID);

ALTER TABLE CA_SALES_ORDER_ITEM ADD CONSTRAINT FK_CA_SALES_ORDER_ITEM_4 FOREIGN KEY (UNIT_CODE_ID) REFERENCES CA_UNIT_CODE (ID);

CREATE SEQUENCE SEQ_CA_SALES_ORDER_ITEM START WITH 1 INCREMENT BY 1 NOMAXVALUE NOMINVALUE CACHE 20 NOORDER;


-- =============================================================================================
-- CA_SALES_INVOICE, CA_SALES_INVOICE_ITEM
-- =============================================================================================

CREATE
    TABLE CA_SALES_INVOICE
    (
    	ID NUMBER NOT NULL,
    	CUSTOMER_ID NUMBER,
    	INVOICE_TYPE NUMBER(1) DEFAULT 0,
...
ALTER TABLE CA_SALES_INVOICE ADD CONSTRAINT PK_CA_SALES_INVOICE PRIMARY KEY(ID);

ALTER TABLE CA_SALES_INVOICE ADD CONSTRAINT FK_CA_SALES_INVOICE_1 FOREIGN KEY (ID) REFERENCES CA_DOCUMENT (ID);

ALTER TABLE CA_SALES_INVOICE ADD CONSTRAINT FK_CA_SALES_INVOICE_2 FOREIGN KEY (CUSTOMER_ID) REFERENCES CA_CUSTOMER (ID);

CREATE
    TABLE CA_SALES_INVOICE_ITEM
    (
    	ID NUMBER NOT NULL,
    	INVOICE_ID NUMBER,
    	ORDER_ID NUMBER,
        ...
        SHIPPED_DATE DATE,
        QUANTITY_TO_BACK_ORDER NUMBER(15,2),
        QUANTITY_TO_BILLED NUMBER(15,2),
        QUANTITY_ALLOCATED NUMBER(15,2),
        QUANTITY_FULFILLED NUMBER(15,2),
        -- STANDARD METADATA COLUMN
        MD_ST NUMBER(1) DEFAULT 0,
...
ALTER TABLE CA_SALES_INVOICE_ITEM ADD CONSTRAINT PK_CA_SALES_INVOICE_ITEM PRIMARY KEY(ID);

ALTER TABLE CA_SALES_INVOICE_ITEM ADD CONSTRAINT FK_CA_SALES_INVOICE_ITEM_1 FOREIGN KEY (INVOICE_ID) REFERENCES CA_SALES_INVOICE (ID);

ALTER TABLE CA_SALES_INVOICE_ITEM ADD CONSTRAINT FK_CA_SALES_INVOICE_ITEM_2 FOREIGN KEY (ORDER_ID) REFERENCES CA_SALES_ORDER (ID);

ALTER TABLE CA_SALES_INVOICE_ITEM ADD CONSTRAINT FK_CA_SALES_INVOICE_ITEM_3 FOREIGN KEY (ITEM_ID) REFERENCES CA_ITEM (ID);

ALTER TABLE CA_SALES_INVOICE_ITEM ADD CONSTRAINT FK_CA_SALES_INVOICE_ITEM_4 FOREIGN KEY (SITE_CODE_ID) REFERENCES CA_SITE_CODE (ID);

ALTER TABLE CA_SALES_INVOICE_ITEM ADD CONSTRAINT FK_CA_SALES_INVOICE_ITEM_5 FOREIGN KEY (UNIT_CODE_ID) REFERENCES CA_UNIT_CODE (ID);

CREATE SEQUENCE SEQ_CA_SALES_INVOICE_ITEM START WITH 1 INCREMENT BY 1 NOMAXVALUE NOMINVALUE CACHE 20 NOORDER;
