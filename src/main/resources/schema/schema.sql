...
ALTER TABLE CA_SITE ADD CONSTRAINT PK_CA_SITE PRIMARY KEY(ID);

ALTER TABLE CA_SITE ADD CONSTRAINT UNQ_CA_SITE UNIQUE (CODE);

CREATE SEQUENCE SEQ_CA_SITE START WITH 1 INCREMENT BY 1 NOMAXVALUE NOMINVALUE CACHE 20 NOORDER;
...
ALTER TABLE CA_PURCHASE_ORDER_ITEM ADD CONSTRAINT FK_CA_PURCHASE_ORDER_ITEM_2 FOREIGN KEY (SITE_ID) REFERENCES CA_SITE (ID);
