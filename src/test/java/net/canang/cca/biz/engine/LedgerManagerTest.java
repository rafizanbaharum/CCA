...
public class LedgerManagerTest {
    ...
    private Logger log = LoggerFactory.getLogger(LedgerManagerTest.class);
    ...
    public void testPost() {
        ...
        String referenceNo = "JRL" + String.valueOf(System.currentTimeMillis()).substring(0, 10);
        ...
        log.debug("test post");
        CaJournal unpostedJournal = journalDao.findByReferenceNo(referenceNo);
        ledgerManager.post(unpostedJournal);
    }
}
